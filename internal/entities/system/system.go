...
type Info struct {
	...
	Power           *powerentity.Diagnostics `json:"power,omitempty" cbor:"25,keyasint,omitempty"`
	ProtocolVersion string                   `json:"pv,omitempty" cbor:"26,keyasint,omitempty"` // upstream feature/protocol compatibility
}
